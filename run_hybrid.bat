...
start cmd /k "py -m uvicorn full_structure.hybrid_pipeline.document_hybrid_pipeline:app --port 8008 --reload"
start cmd /k "py -m uvicorn full_structure.hybrid_pipeline.query_hybrid_pipeline:app --port 8017 --reload"
